...
export const HireusFour = ({navigation}) => {
  ...
  return (
    <View style={{flex:1, backgroundColor:'#E5E5E5'}}>
      <View style={{ width:'75%', height:4,backgroundColor:'#956DFF'}}></View>
    <ScrollView style={style.view}>     
      <View style={{marginTop:10}}>
        <Text  style={style.questionText}>Question 4 0f 5</Text>
      </View>
      ...
      <TouchableOpacity style={style.mainNextstyle} onPress={() => {
            navigation.navigate('hireus-five');
          }}>
          <LinearGradient
